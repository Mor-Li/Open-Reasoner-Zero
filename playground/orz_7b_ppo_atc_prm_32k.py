...
class PPOExpConfig(BasePPOExpConfig):
    ...
    prompt_max_len: int = 32768  # 提示文本的最大长度
    ...
    micro_rollout_batch_size: int = 64 if not DEBUG_MODE else 128  # 微批量rollout的大小
    ...
    # 生成相关设置
    generate_max_len: int = 32768  # 生成文本的最大长度
    packing_max_len: int = 65536  # 打包的最大长度，必须大于等于prompt_max_len+generate_max_len(32768+32768=65536)
    max_len: int = 32768  # 最大序列长度
