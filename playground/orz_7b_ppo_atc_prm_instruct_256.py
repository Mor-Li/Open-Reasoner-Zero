...
class PPOExpConfig(BasePPOExpConfig):
    ...
    prompt_data: ListConfig = ListConfig(
        [
            "data/atc_data_256/ea_zh.json",  # 祖先追溯测试-中文
            "data/atc_data_256/ea_en.json",  # 祖先追溯测试-英文
            "data/atc_data_256/na_zh.json",  # 第n代祖先-中文
            "data/atc_data_256/na_en.json",  # 第n代祖先-英文
            "data/atc_data_256/nd_zh.json",  # 第n代后代-中文
            "data/atc_data_256/nd_en.json",  # 第n代后代-英文
            "data/atc_data_256/rd_zh.json",  # 亲属距离-中文
            "data/atc_data_256/rd_en.json",  # 亲属距离-英文
        ]
    )
    eval_prompt_data: ListConfig = ListConfig(
        [
            "data/atc_data_256/eval_data/ea_zh.json",
            "data/atc_data_256/eval_data/ea_en.json",
            "data/atc_data_256/eval_data/na_zh.json",
            "data/atc_data_256/eval_data/na_en.json",
            "data/atc_data_256/eval_data/nd_zh.json",
            "data/atc_data_256/eval_data/nd_en.json",
            "data/atc_data_256/eval_data/rd_zh.json",
            "data/atc_data_256/eval_data/rd_en.json",
        ]
    )
